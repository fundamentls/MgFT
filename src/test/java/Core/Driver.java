...
public class Driver {
    ...
    private static void setSystem() {
        //TODO: Add more OS support for ChromeDriver
        String OS = System.getProperty("os.name").toLowerCase();

        if (OS.indexOf("win") >= 0){
            System.setProperty("webdriver.chrome.driver", "src/test/java/basegrp/chromedriver.exe");
        }
    }
    ...
    private static WebDriver getChromeInstance() {
        ...
        System.out.println("About to use Chrome");
        return _instance;
    }
}
